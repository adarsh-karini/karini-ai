...
const termsofuse = () => {
  return (
    <div className={`${poppins.variable} ${inter.className} bg-white`}>
      <div className="max-w-screen-xl mx-auto space-y-8 py-10 px-4 lg:px-0">
        <h1 className="text-primary-600 text-center text-2xl lg:text-4xl font-bold">
          Terms of use
        </h1>
        <div className="space-y-2">
          <h2 className="text-black text-lg font-semibold">
            AGREEMENT BETWEEN USER AND TENSORACT INC
          </h2>
          <p className="text-secondary-700 text-sm leading-relaxed">
            The Tensoract Inc Web Site is comprised of various Web pages
            operated by Tensoract Inc. The Tensoract Inc Web Site is offered to
            ...
            Tensoract Inc Web Site constitutes your agreement to all such terms.
        ...
        <div className="space-y-2">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            Tensoract Inc reserves the right to change the terms & conditions
            and notices under which the Tensoract Inc Web Site is offered.
            including but not limited to the charges associated with the use of
            the Tensoract Inc Web Site.
          </p>
        </div>
        <div className="space-y-2">
          <h2 className="text-black text-lg font-semibold">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            The Tensoract Inc Web Site may contain links to other Web Sites
            (&quot;Linked Sites&quot;). The Linked Sites are not under the
            control of Tensoract Inc and Tensoract Inc is not responsible for
            ...
            Linked Site. Tensoract Inc is not responsible for webcasting or any
            other form of transmission received from any Linked Site. Tensoract
            Inc is providing these links to you only as a convenience. and the
            inclusion of any link does not imply endorsement by Tensoract Inc of
        ...
        <div className="space-y-2">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            As a condition of your use of the Tensoract Inc Web Site, you
            warrant to Tensoract Inc that you will not use the Tensoract Inc Web
            Site for any purpose that is unlawful or prohibited by these terms,
            conditions. and notices. You may not use the Tensoract Inc Web Site
            in any manner which could damage. disable. overburden. or impair the
            Tensoract Inc Web Site or interfere with any other party&apos;s use
            and enjoyment of the Tensoract Inc Web Site. You may not obtain or
            attempt to obtain any materials or information through any means not
            intentionally made available or provided for through the Tensoract
            Inc Web Sites.
          </p>
        </div>
        <div className="space-y-2">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            The Tensoract Inc Web Site may contain bulletin board services. chat
            ...
            group (collectively. &apos;Communication Services&apos;). you agree
            ...
            Communication Service. By way of example, not as a limitation, you
          ...
          <div className="space-y-2">
            ...
            <p className="text-secondary-700 text-sm leading-relaxed">
              - Tensoract Inc has no obligation to monitor the Communication
              Services. However. Tensoract Inc reserves the right to review
              materials posted to a Communication Service and to remove any
              materials in its sole discretion.
            </p>
            <p className="text-secondary-700 text-sm leading-relaxed">
              - Tensoract Inc reserves the right to terminate your access to any
              or all of the Communication Services at any time without notice
              for any reason whatsoever.
            </p>
            <p className="text-secondary-700 text-sm leading-relaxed">
              - ensoract Inc reserves the right at all times to disclose any
              ...
              or in part. in Tensoract Inc sole discretion.
            </p>
            <p className="text-secondary-700 text-sm leading-relaxed">
            ...
            <p className="text-secondary-700 text-sm leading-relaxed">
              - Tensoract Inc does not control or endorse the content. messages
              or information found in any Communication Service and. therefore.
              Tensoract Inc specifically disclaims any liability with regard to
              ...
              not authorized Tensoract Inc spokespersons. and their views do not
              necessarily reflect those of Tensoract Inc.
            </p>
            <p className="text-secondary-700 text-sm leading-relaxed">
        ...
        <div className="space-y-2">
          <h2 className="text-black text-lg font-semibold">
            MATERIALS PROVIDED TO TENSORACT INC OR POSTED AT ANY TENSORACT INC
            WEBSITE
          </h2>
          <p className="text-secondary-700 text-sm leading-relaxed">
            Tensoract Inc does not claim ownership of the materials you provide
            to Tensoract Inc (including feedback and suggestions) or post.
            upload. input or submit to any Tensoract Inc Web Site or its
            associated services (collectively &apos;Submissions&apos;). However.
            by posting. uploading. inputting. providing or submitting your
            Submission you are granting Tensoract Inc. its affiliated companies
            ...
            connection with your Submission. No compensation will be paid with
            respect to the use of your Submission. as provided herein. Tensoract
            Inc is under no obligation to post or use any Submission you may
            provide and may remove any Submission at any time in Tensoract Inc
        ...
        <div className="space-y-2">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            ...
            AVAILABLE THROUGH THE TENSORACT INC WEB SITE MAY INCLUDE
            INACCURACIES OR TYPOGRAPHICAL ERRORS. CHANGES ARE PERIODICALLY ADDED
            TO THE INFORMATION HEREIN. TENSORACT INC AND/OR ITS SUPPLIERS MAY
            MAKE IMPROVEMENTS AND/OR CHANGES IN THE TENSORACT INC WEB SITE AT
            ANY TIME. ADVICE RECEIVED VIA THE TENSORACT INC WEB SITE SHOULD NOT
            ...
            ADVICE TAILORED TO YOUR SITUATION. TENSORACT INC AND/OR ITS
            ...
            CONTAINED ON THE TENSORACT INC WEB SITE FOR ANY PURPOSE. TO THE
            ...
            WITHOUT WARRANTY OR CONDITION OF ANY KIND. Tensoract Inc AND/OR ITS
            ...
            IN NO EVENT SHALL TENSORACT INC AND/OR ITS SUPPLIERS BE LIABLE FOR
            ...
            WAY CONNECTED WITH THE USE OR PERFORMANCE OF THE TENSORACT INC WEB
            SITE. WITH THE DELAY OR INABILITY TO USE THE TENSORACT INC WEB SITE
            OR RELATED SERVICES. THE PROVISION OF OR FAILURE TO PROVIDE
            SERVICES. OR FOR ANY INFORMATION. SOFTWARE. PRODUCTS. SERVICES AND
            RELATED GRAPHICS OBTAINED THROUGH THE TENSORACT INC WEB SITE. OR
            OTHERWISE ARISING OUT OF THE USE OF THE TENSORACT INC WEB SITE.
            WHETHER BASED ON CONTRACT. TORT. NEGLIGENCE. STRICT LIABILITY OR
            OTHERWISE. EVEN IF TENSORACT INC OR ANY OF ITS SUPPLIERS HAS BEEN
            ...
            PORTION OF THE TENSORACT INC WEB SITE. OR WITH ANY OF THESE TERMS OF
            USE. YOUR SOLE AND EXCLUSIVE REMEDY IS TO DISCONTINUE USING THE
            TENSORACT INC WEB SITE
          </p>
        </div>
        <div className="space-y-2">
          <h2 className="text-black text-lg font-semibold">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            Tensoract Inc reserves the right. in its sole discretion. to
            terminate your access to the Tensoract Inc Web Site and the related
            services or any portion thereof at any time. without notice. GENERAL
            To the maximum extent permitted by law. this agreement is governed
            by the laws of the State of Washington. U.S.A. and you hereby
            consent to the exclusive jurisdiction and venue of courts in San
            Mateo County. California. U.S.A. in all disputes arising out of or
            relating to the use of the Tensoract Inc Web Site. Use of the
            Tensoract Inc Web Site is unauthorized in any jurisdiction that does
            ...
            between you and Tensoract Inc as a result of this agreement or use
            of the Tensoract Inc Web Site. Tensoract Inc performance of this
            agreement is subject to existing laws and legal process. and nothing
            contained in this agreement is in derogation of Tensoract Inc right
            to comply with governmental. court and law enforcement requests or
            requirements relating to your use of the Tensoract Inc Web Site or
            information provided to or gathered by Tensoract Inc with respect to
            ...
            agreement between the user and Tensoract Inc with respect to the
            Tensoract Inc Web Site and it supersedes all prior or
            contemporaneous communications and proposals. whether electronic.
            oral or written. between the user and Tensoract Inc with respect to
            the Tensoract Inc Web Site. A printed version of this agreement and
        ...
        <div className="space-y-2">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            All contents of the Tensoract Inc Web Site are: 2023 by Tensoract
            Inc and/or its suppliers. All rights reserved.
          </p>
        </div>
        <div className="space-y-2">
          <h2 className="text-black text-lg font-semibold">TRADEMARKS</h2>
          <p className="text-secondary-700 text-sm leading-relaxed">
