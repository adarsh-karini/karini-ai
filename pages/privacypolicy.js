				...
				<div className="max-w-screen-lg mx-auto space-y-4 py-10 px-4 lg:px-0">
					...
					<div className="space-y-2">
						...
						<p className="text-secondary-700 text-sm leading-relaxed">
							...
							or unlawful topic. name. material or information. Related services
							and offerings with links from this web site, including partner
							sites, have their own privacy statements which can be viewed by
							clicking on the corresponding links within each respective web
							site.
						</p>
					</div>
					<div className="space-y-2">
