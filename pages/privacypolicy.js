    ...
    <div className={`${poppins.variable} ${inter.className} bg-white`}>
      <div className="max-w-screen-xl mx-auto space-y-4 py-10 px-4 lg:px-0">
        ...
        <div className="space-y-2">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            We will explicitly ask you when we need information that personally
            identifies you (personal information) or allows us to contact you to
            provide a service or carry out a transaction that you have requested
            such as receiving information about Tensoract Inc products and
            services, ordering e-mail newsletters, joining a limited-access site
            or service, signing up for an event or training, or when downloading
            and/or registering Tensoract Inc products. The personal information
            we collect may include your name, title, company or organization
            name, work e-mail, work phone, work or home address, information
            about your job function, and information about your company. The
            Site may collect certain information about your visit, such as the
            name of the Internet service provider and the Internet Protocol (IP)
            address through which you access the Internet; the date and time you
            access the Site; the pages that you access while at the Site and the
            ...
            trends and administer the site. Our sites may at times also collect
            information about your hardware and software in order to provide a
            requested service.
          </p>
        </div>
        <div className="space-y-2">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            ...
            uses, Tensoract Inc may use personal information to provide you with
            more effective customer service, to improve the Site and any related
            Tensoract Inc products or services, and to make the Site easier to
            ...
            about products and services, and sending information about our
            products, special offers, and other services. We will only provide
            those companies the personal information they need to deliver the
            service. They are required to maintain the confidentiality of the
            information and are prohibited from using that information for any
            other purpose. Tensoract Inc may disclose personal information if
            required to do so by law or in the good faith belief that such
            action is necessary to: (a.) – Conform to the edicts of the law or
            comply with legal process served on Tensoract Inc or the Site; (b.)
            – Protect and defend the rights or property of Tensoract Inc and our
            family of Web sites; or (c.) – Act in urgent circumstances to
            protect the personal safety of Tensoract Inc employees or agents,
            users of Tensoract Inc products or services, or members of the
            public. Personal information collected on the Site may be stored and
            processed in the United States or any other country in which
            Tensoract Inc or its affiliates, subsidiaries or agents maintain
            facilities, and by using the Site, you consent to any such transfer
        ...
        <div className="space-y-2">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            We use may use cookies on this Site to personalize user experiences.
            ...
            cookie to you. One of the primary purposes of cookies is to provide
            a convenience feature to save you time. For example, if you
            personalize a web page, or navigate within a site, a cookie helps
            the site to recall your specific information on subsequent visits.
            This simplifies the process of delivering relevant content, eases
            site navigation, and so on. When you return to the Web site, the
            information you previously provided can be retrieved, so you can
            easily use the site’s features that you customized. We may
            occasionally opt to share aggregated site statistics with partner
            companies, but do not allow other companies to place cookies on our
            sites unless there is a temporary, overriding customer value (such
            as merging into Tensoract Inc .coma site that relies on third-party
            ...
            the interactive features of this or other Web sites you visit.
          </p>
        </div>
        <div className="space-y-2">
          <h2 className="text-black text-lg font-semibold">
        ...
        <div className="space-y-2">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            ...
            will also revise the “updated” date at the top of this Privacy page,
            and may also send you a notification directly. We encourage you to
            ...
            privacy statement and any updates.If you have questions regarding
            this statement, please contact Tensoract Inc at the postal and/or
        ...
        <div className="space-y-2">
          ...
          <p className="text-secondary-700 text-sm leading-relaxed">
            ...
            statement. If you believe that Tensoract Inc has not adhered to this
            privacy statement, please contact us electronically or via postal
            mail at the addresses provided below, and we will use commercially
            reasonable efforts to promptly determine and remedy the problem. To
            make such a request, please send an email to help
