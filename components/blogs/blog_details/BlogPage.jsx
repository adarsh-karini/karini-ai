					...
					<div className="space-y-6">
						<div className="space-y-1">
							...
							<p className="text-sm text-secondary-700">
								Generative AI is not just a fleeting trend; it’s a
								...
								Generation (RAG), introduced by Meta in 2020(1), is now familiar
								in the corporate world. However, the deployment of such
								technologies at an enterprise level often encounters hurdles
								like task-specificity, accuracy, and the need for robust
								controls.
							</p>
						</div>
						<div className="space-y-1">
						...
						<div className="space-y-2">
							...
							<p className="text-sm text-secondary-700">
								...
								top of their existing platform. Unlike ML Platforms, Generative
								AI platforms need to focus on capabilities to contextualize
								Large Language models and deploy capabilities to enable smarts
								in applications such as Copilots. Hence we propose a radically
								different approach to fulfill the promise of industrialized Gen
								AI
							</p>
						</div>
						<div className="space-y-1">
