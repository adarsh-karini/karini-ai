...
import { genaiSubServicesData } from "@/content/services/genai/genaiData";
...
const OurServices = () => {
	...
	return (
		<section className="relative bg-white px-4 lg:px-4 xl:px-0 py-5">
						...
						<div className="space-y-6">
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
								{showService[0].services.map((service, ind) => (
									...
									>
										<div className="h-40 bg-about_img object-contain p-6 rounded-t-lg">
