						...
						<div className="flex-1 space-y-4">
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								{ourServicesData.map((data, index) => (
									<div
										key={index}
										className="flex flex-col bg-gradient-to-br from-gray-800 to-gray-950 space-y-6 border border-secondary-800 shadow-lg shadow-primary-800/10 rounded-lg p-6"
									>
										<div className="flex space-x-4">
											...
											<h3 className="flex-1 text-white font-semibold sm:text-base lg:text-lg">
												{data.title}
											</h3>
										</div>
										<div className="flex-1 flex flex-col justify-between space-y-6">
											<p className="flex-1 text-secondary-300 text-sm leading-relaxed">
												{data.overview}
											</p>
