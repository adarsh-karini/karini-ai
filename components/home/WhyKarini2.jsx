	...
	return (
		<section className="bg-white px-4 lg:px-0 py-20 overflow-hidden">
			<div className="relative z-10 max-w-screen-lg mx-auto">
				...
				<div className="-z-10 absolute -right-32 -top-1 bg-gradient-to-br from-primary-400 to-primary-800 rounded-full shadow-lg">
					<div className="p-20 m-8 bg-white rounded-full"></div>
				</div>
				<div className="-z-10 absolute -left-14 -bottom-10 p-14 bg-gradient-to-br from-primary-400 to-primary-800 rounded-full shadow-lg"></div>
