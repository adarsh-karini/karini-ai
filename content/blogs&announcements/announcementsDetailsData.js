...
export const announcementsDetailsData = [
	{
		...
		SEO_data: {
			...
			schemaMarkup: {
				...
				image:
					"https://www.karini.ai/assets/images/blogs/Streaming-eye-catcher.png",
				author: {
					"@type": "Person",
					name: "Deepali Rajale",
				},
	...
	},
	{
		...
		SEO_data: {
			...
			schemaMarkup: {
				...
				image:
					"https://www.karini.ai/assets/images/blogs/Karini_Evolves_Prompting_Experience.png",
				author: {
					"@type": "Person",
					name: "Deepali Rajale",
				},
	...
	},
	{
		...
		SEO_data: {
			...
			schemaMarkup: {
				...
				image:
					"https://www.karini.ai/assets/images/blogs/Bedrock_Models_Support.png",
				author: {
					"@type": "Person",
					name: "Deepali Rajale",
				},
				...
				data: [
					{
						...
						fontWeight: fontWeight.normal,
						fontStyle: fontStyle.normal,
						value: "Let's democratize Generative AI together!",
					},
				],
			},
		],
	...
	},
	{
		...
		SEO_data: {
			...
			schemaMarkup: {
				...
				image:
					"https://www.karini.ai/assets/images/blogs/Databricks_Partnership.png",
				author: {
					"@type": "Person",
					name: "Deepali Rajale",
				},
				...
				data: [
					{
						...
						fontWeight: fontWeight.normal,
						fontStyle: fontStyle.normal,
						value: "Key Benefits of the Partnership:",
					},
					{
						type: type.list,
						fontSize: fontSize.medium,
	...
	},
	{
		...
		SEO_data: {
			...
			schemaMarkup: {
				...
				image:
					"https://www.karini.ai/assets/images/blogs/AWS_Partner_Announcement_Eye_Catcher.png",
				author: {
					"@type": "Person",
					name: "Deepali Rajale",
				},
	...
	},
	{
		...
		SEO_data: {
			...
			schemaMarkup: {
				...
				image:
					"https://www.karini.ai/assets/images/blogs/Karini_AI_now_on_AWS_Marketplace.png",
				author: {
					"@type": "Person",
					name: "Deepali Rajale",
				},
			...
			},
			{
				...
				data: [
					...
					},
					{
						...
						value: `<ul class="space-y-2" style="list-style-type: disc; padding-left: 50px">
						        <li>
								<h3 class="list-heading">Effortless Development & Deployment:</h3> Turn innovative ideas into reality in minutes, with no coding required. This frees your team to focus on creative and strategic tasks, leading to increased productivity.
								</li>
						        <li>
								<h3 class="list-heading">Unparalleled Security & Governance:</h3>  Built-in observability and guardrails ensure responsible experimentation and deployment, while robust security features keep your data safe and compliant. This translates to enhanced security and maintained user trust, giving you a sense of confidence in your operations.
								</li>
								<li>
								<h3 class="list-heading">Streamlined Workflow:</h3>  Integrate seamlessly with your existing AWS infrastructure for a frictionless experience.
								</li>
								<li>
								<h3 class="list-heading">Faster Time to Market:</h3>  With Karini AI's rapid development tools, you can quickly bring your AI-powered products and services to market, giving you a crucial competitive edge and a sense of empowerment.
								</li>
								<li>
								<h3 class="list-heading"> Improved Quality of AI Applications:</h3> Our trust, safety controls, and human feedback capabilities ensure reliable and high-quality AI outputs.
								</li>
								<li>
				...
				data: [
					{
						...
						fontStyle: fontStyle.normal,
						value:
							"Ready to unlock the transformative potential of GenAI? Don't wait, visit Karini AI on AWS Marketplace today and start your journey towards AI-driven innovation: <a style='text-decoration: underline; color:rgb(37 99 235 / var(--tw-text-opacity))' href='https://aws.amazon.com/marketplace/pp/prodview-7wz23ginqou4w?sr=0-1&ref_=beagle&applicationId=AWSMPContessa' target='_blank'>Link to Karini AI on AWS Marketplace</a>",
					},
				],
			},
			{
		...
		sections: [
				...
				data: [
					{
						...
						<ol style='list-style: inside; list-style-type: decimal; margin-left: 25px;'>
						        <li>
								<h3 class="list-heading">Mitigating Misinformation and Manipulation:</h3> LLMs in chatbots can unintentionally spread misinformation without content safety guardrails, especially in critical areas like healthcare and finance. Guardrails ensure information accuracy, protecting users from being misled.
								</li>
								<li>
								<h3 class="list-heading">Preventing Harmful and Biased Outputs:</h3> LLMs may produce harmful or biased content, leading to offensive language or discrimination. Here, content safety guardrails play a crucial role. They filter such outputs and ensure AI generates inclusive and respectful content, providing the audience a sense of reassurance and security.
								</li>
								<li>
								<h3 class="list-heading">Enhancing User Trust and Safety:</h3>LLM chatbots may generate offensive or false responses without safeguards. Content safety guardrails build user trust by ensuring safer interactions, particularly in applications for children or vulnerable populations.
								</li>
								<li>
								<h3 class="list-heading">Protecting Your Brand and Business:</h3> Chatbot conversations can stray into irrelevant or controversial topics, harming your brand. Guardrails prevent security risks by ensuring LLMs don't expose confidential information or produce harmful outputs.
								</li>
								<li>
								<h3 class="list-heading">Facilitating Regulatory Compliance:</h3> Regulatory bodies scrutinize AI for content safety and user protection. Implementing guardrails helps developers comply with regulations, avoid legal issues, and promote sustainable AI deployment.
								</li>
								<li>
								<h3 class="list-heading">Ensuring Ethical Use of AI:</h3> Content safety guardrails monitor and control generated content, providing a safer user experience. This is especially crucial for applications targeting children and vulnerable groups. It assures users of the technology's reliability and encourages a responsible and considerate approach to AI use.	
								</li>
								</ol>`,
					},
				],
			...
			},
			{
				...
				data: [
					{
						type: type.iframe,
						path: "https://www.youtube.com/embed/SM23u0W_Gao?si=RnrplOcUN_nW1oZx",
						title: "AI safety with support for Guardrails",
						width: 700,
						height: 455,
					},
				],
				...
				data: [
					{
						...
						fontStyle: fontStyle.normal,
						value:
							'A recent survey by <a href="https://www.technologyreview.com/2023/10/05/1080618/laying-the-foundation-for-data-and-ai-led-growth/" target="_blank" rel=" nofollow" class="text-blue-600 hover:underline">MIT Tech Review </a>underscored that over 90% of enterprises have actively invested in Generative AI projects, so the heavy lifting is underway - and the time to value (TTV) clock is running. According to another study by <a href="https://www.everestgrp.com/press-releases/enterprises-aim-to-move-beyond-pilots-accelerate-consumption-of-ai-in-2024everest-group-yates-ltd/" target="_blank" rel=" nofollow" class="text-blue-600 hover:underline">Everest Group</a>, more than 55% of projects are stuck in pilot stages and may never see production due to a lack of necessary security, governance, or safety controls.',
					},
				],
			},
			{
